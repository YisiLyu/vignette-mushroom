...
### Preprocess the data
    /* Sample Code: (turn a categorical variable into factors)
    /* Action (turn other categorical variables into factors)

## Intuition and Architecture

### Understanding Decision Trees
    /* Description: A decision tree is a binary tree in which the paths represent classification rules.
    /* Sample code: 
    /* Action:
